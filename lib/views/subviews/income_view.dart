...
class IncomeViewUI extends StatefulWidget {
  ...
  IncomeViewUI({super.key, this.user});

  @override
  State<IncomeViewUI> createState() => _IncomeViewState();
}

class _IncomeViewState extends State<IncomeViewUI> {
